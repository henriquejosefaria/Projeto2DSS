...
public class Pagamento extends javax.swing.JFrame {
     ...
     */
    public Pagamento(Selecao selecao) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Morada de Cliente:");

        jLabel2.setText("Nome de Cliente:");

        jLabel3.setText("Email de Cliente:");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
         JOptionPane.showMessageDialog(null,"Pagamento efectuado com sucesso!", "Message" , JOptionPane.INFORMATION_MESSAGE);
         selecao.dispose();
         this.dispose();
