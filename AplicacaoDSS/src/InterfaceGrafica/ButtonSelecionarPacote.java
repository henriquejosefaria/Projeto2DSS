...
class ButtonSelecionarPacote extends DefaultCellEditor {
  ...
  public ButtonSelecionarPacote(JCheckBox checkBox,Facade facade,JTable table, List<Pacote> list,Selecao selecao) {
    super(checkBox);
    button = new JButton();
    ...
    button.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent e) {
          ...
          Pacote comp = list.get(i);
          try {
          facade.setSelectedConfig(comp.getConfigId());
          facade.setConfigSaved(false);
          facade.setStock(false);
          selecao.setEncomendaButton(false);
          selecao.desenhaConfigFrame();
          } catch (SQLException ex) {
              Logger.getLogger(ButtonSelecionarPacote.class.getName()).log(Level.SEVERE, null, ex);
          }
      }
    });
  }
