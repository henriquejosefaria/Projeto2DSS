...
class ButtonAtualizarStock extends DefaultCellEditor {
  ...
  public ButtonAtualizarStock(JCheckBox checkBox,Facade facade,JTable table, List<Componente> list, JTextField t) {
    super(checkBox);
    button = new JButton();
    ...
    button.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent e) {
          ...
          if(valor==null) {
              ...
              list.get(i).addStock(Integer.parseInt(valor));
              table.setValueAt(list.get(i).getStock(),i,2);
              try {
                  facade.getCompDAO().updateStockComponente(list.get(i));
              } catch (SQLException ex) {
                  Logger.getLogger(ButtonAtualizarStock.class.getName()).log(Level.SEVERE, null, ex);
              }
          }
      }
    });
